<template>
  <div>
    <Breadcrumb>
      <template v-slot:heading>Service Single</template>
    </Breadcrumb>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 order-lg-2 order-1">
                    <img class="img-fluid mb-60 rounded-top" src="" alt="service">
                    <h3 class="mb-10">Marketing Oriented To The Targated Customers</h3>
                    ...
                    <!-- chart -->
                    <img class="img-fluid w-100 mb-40" src="" alt="chart">
                    ...
                    <div class="mb-md-50">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-5 mt-sm-4 mt-md-0">
                                <img class="img-fluid rounded" src="" alt="benifit">
                            </div>
                        </div>
                    </div>
                </div>
