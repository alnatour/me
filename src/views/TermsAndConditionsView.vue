<template>
    <div>
        <Breadcrumb>
            <template v-slot:heading>Terms and Conditions</template>
        </Breadcrumb>

        <section class="section">
            <div class="container">
                <div class="row mb-4">
                    <h2 class="mb-4">Terms and Conditions ("Terms")</h2>

                    <h5>Last updated: 10.2022</h5>

                    <p>
                        Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using
                        the
                        http://www.alnatour.com (change this) website and the My Mobile App (change this) mobile
                    ...
                    <p>
                        ...
                        their
                        websites or apps. For the full disclosure section, create your own Terms and Conditions.
                    </p>
                    ...
                    <p>
                        ...
                        and
                        agree that My Company (change this) shall not be responsible or liable, directly or indirectly,
                        for
                    ...
                    <p>
                        ...
                        revision is material we will try to provide at least 30 (change this) days' notice prior to any
                        new
