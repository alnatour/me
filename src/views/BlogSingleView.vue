<template>
  <div>
    <Breadcrumb>
      <template v-slot:heading>Blog Single</template>
    </Breadcrumb>
        ...
        <div class="row">
          <div class="col-lg-8 py-100">
            <div class="border rounded bg-white">
              <img class="img-fluid w-100 rounded-top" src="@/assets/images/blog/blog-single.jpg" alt="blog-image">
              <div class="p-4">
                ...
                <div class="bg-gray p-5 rounded mb-60">
                  <p class="text-dark font-primary mb-30">Excepteur sint occaecat cupidatat non proident sunt culpa
                    officia
                ...
                <div class="row mb-20">
                  <div class="col-sm-5 pr-sm-0 align-self-center">
                    <img class="img-fluid w-100 rounded mr-4 mb-4 mb-sm-0" src="@/assets/images/blog/blog-testimonial.jpg"
                      alt="client image">
                  </div>
                  <div class="col-sm-7">
            ...
            <div>
              ...
              <div class="d-flex mb-4">
                <div class="mr-3">
                  <img class="img-fluid rounded w-100" src="@/assets/images/blog/comment-1.jpg" alt="user-image">
                </div>
              ...
              <div class="d-flex mb-4">
                <div class="mr-3">
                  <img class="img-fluid rounded w-100" src="@/assets/images/blog/comment-2.jpg" alt="user-image">
                </div>
                <div class="border rounded py-3 px-4">
                  <div class="border-bottom mb-10">
                    <h5>Mikymouse</h5>
            ...
            <div class="bg-white px-4 py-100 sidebar-box-shadow">
              ...
              <div class="mb-50">
                ...
                <div class="d-flex py-3 border-bottom">
                  <div class="mr-4">
                    <a href="blog-single.html">
                      <img class="rounded" src="@/assets/images/blog/post-thumb-sm-01.jpg" alt="post-thumb">
                    </a>
                  </div>
                  <div>
                    <h6 class="mb-3">
                ...
                <div class="d-flex py-3 border-bottom">
                  <div class="mr-4">
                    <a href="blog-single.html">
                      <img class="rounded" src="@/assets/images/blog/post-thumb-sm-02.jpg" alt="post-thumb">
                    </a>
                  </div>
                  <div class="content">
                    <h6 class="mb-3">
                ...
                <div class="d-flex py-3">
                  <div class="mr-4">
                    <a href="blog-single.html">
                      <img class="rounded" src="@/assets/images/blog/post-thumb-sm-03.jpg" alt="post-thumb">
                    </a>
                  </div>
                  <div class="content">
                    <h6 class="mb-3">
